...
<div class="container-fluid">
    <div>
        ...
        <h1 style="text-align: center; margin-bottom: 10px;">Contest List
    ...
    <div id="search" style="display:none;">
        <form name="search" action="" method="POST" style="margin: 5px">
            <fieldset style="display: inline">
                ...
                Contest's name:<@spring.formInput "searchForm.searchField", "", "text"/>
                <br>
            </fieldset>
            <br>
        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list contests as contest>
                <tr class="" style="font-size: larger">
                    <td class="align-middle">${contest.id}</td>
                    <td class="align-middle">${contest.name}</td>
                    <td class="align-middle">${contest.description}</td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${contest.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${contest.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
