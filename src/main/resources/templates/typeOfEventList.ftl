...
<div class="container-fluid">
    <div>
        ...
        <h1 style="text-align: center; margin-bottom: 10px;">Type of Event List
        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list typeOfEvents as typeOfEvent>
                <tr class="" style="font-size: larger">
                    <td class="align-middle">${typeOfEvent.id}</td>
                    <td class="align-middle">${typeOfEvent.type}</td>
                    <td class="align-middle">${typeOfEvent.description}</td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${typeOfEvent.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${typeOfEvent.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
