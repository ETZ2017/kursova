        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list genres as genre>
                <tr class="" style="font-size: larger">
                    ...
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${genre.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${genre.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
