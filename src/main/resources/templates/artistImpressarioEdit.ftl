...
<head>
    <meta charset="UTF-8">
    <title>Edit Artist-Impressario</title>
...
<form name="artistImpressario" action="" method="POST">
    <ul class="list-group" style="font-size: large;
        ...
        <li style="font-size: 2.5em; text-align: center; background-color: transparent;">
            Edit artist-impressario
        </li>
        <li style="font-size: 1.5em; margin: 8px; background-color: transparent; border-radius: 60px">
            Artist:
            <br>
            <@spring.formSingleSelect "artistImpressarioForm.artist", artist, ""/>
        </li>
        <li style="font-size: 1.5em; margin: 8px; background-color: transparent; border-radius: 60px">
            Impressario:
            <br>
            <@spring.formSingleSelect "artistImpressarioForm.impressario", impressario, ""/>
        </li>
