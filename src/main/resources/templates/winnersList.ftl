        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list winnerss as winners>
                <tr class="" style="font-size: larger">
                    <td class="align-middle">${winners.id}</td>
                    <td class="align-middle">${winners.artist.firstName}</td>
                    <td class="align-middle">${winners.place.place}</td>
                    <td class="align-middle">${winners.contest.name}</td>
                    <td class="align-middle">${winners.description}</td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${winners.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${winners.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
