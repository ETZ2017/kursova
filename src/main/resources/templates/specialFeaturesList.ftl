...
<div class="container-fluid">
    <div>
        ...
        <h1 style="text-align: center; margin-bottom: 10px;">Special Features List
        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list specialFeaturess as specialFeatures>
                <tr class="" style="font-size: larger">
                    <td class="align-middle">${specialFeatures.id}</td>
                    <td class="align-middle">${specialFeatures.type}</td>
        <#--            <td>${specialFeatures.value}</td>-->
                    <td class="align-middle">${specialFeatures.description}</td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${specialFeatures.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${specialFeatures.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
