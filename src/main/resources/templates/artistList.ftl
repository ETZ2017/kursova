        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list artists as artist>
                <tr class="" style="font-size: larger">
                    ...
                    <td class="align-middle">${artist.description}</td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${artist.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${artist.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
