...
<div class="container-fluid">
    <div>
        ...
        <h1 style="text-align: center; margin-bottom: 10px;">Type of Building List
        ...
        <table class="table table-sm table-striped table-bordered" style="vertical-align: center; border: 3px solid #31373e">
            ...
            <#list typeOfBuildings as typeOfBuilding>
                <tr class="" style="font-size: larger">
                    <td class="align-middle">${typeOfBuilding.id}</td>
                    <td class="align-middle">${typeOfBuilding.type}</td>
                    <td class="align-middle">${typeOfBuilding.description}</td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${typeOfBuilding.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                    <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${typeOfBuilding.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
                </tr>
            </#list>
        </table>
    </div>
