...
<head>
    <meta charset="UTF-8">
    <title>Edit Artist in genre</title>
...
<form name="artistInGenre" action="" method="POST">
    <ul class="list-group" style="font-size: large;
        ...
        <li style="font-size: 2.5em; text-align: center; background-color: transparent;">
            Edit artist in genre
        </li>
        <li style="font-size: 1.5em; margin: 8px; background-color: transparent; border-radius: 60px">
            Artist:
            <br>
            <@spring.formSingleSelect "artistInGenreForm.artist", mavs, ""/>
        </li>
        <li style="font-size: 1.5em; margin: 8px; background-color: transparent; border-radius: 60px">
            Artist's genre:
            <br>
            <@spring.formSingleSelect "artistInGenreForm.genre", genre, ""/>
        </li>
