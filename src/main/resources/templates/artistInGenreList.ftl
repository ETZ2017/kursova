    ...
    <div class="table-responsive-md">
        ...
        <#list artistInGenres as artistInGenre>
            <tr class="" style="font-size: larger">
                <td class="align-middle">${artistInGenre.id}</td>
                <td class="align-middle">${artistInGenre.artist.firstName}</td>
                <td class="align-middle">${artistInGenre.genre.genre}</td>
                <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="edit/${artistInGenre.id}"><button class="btn btn-outline-dark">Edit</button></a></td>
                <td class="align-middle" style="width:1%; white-space:nowrap;"><a href="delete/${artistInGenre.id}"><button class="btn btn-outline-dark">Delete</button></a></td>
            </tr>
        </#list>
        </table>
    </div>
